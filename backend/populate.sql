...
insert into skill values 
    ...
    (30000, 'Communication'),
    (30001, 'Active Listening'),
    (30002, 'Product Knowledge'),
    (30003, 'Empathy'),
    (30004, 'Emotional Intelligence'),
    (30005, 'Negotiation'),
    (30006, 'Management'),
    (30007, 'Confidence'),
    (30008, 'Prospecting'),
    (30009, 'Growth Mindset'),
    (30010, 'Objection Handling'),
    (40001, 'Technical proficiency'),
    (40002, 'Data processing skills'),
    (40003, 'Product development'),
    (40004, 'Risk analysis'),
    (40005, 'Strategic planning'),
    (40006, 'Budget management'),
    (40007, 'Staff management'),
    (40008, 'Decision-making skills'),
    (40009, 'Problem-solving skills'),
    (40010, 'Communication skills'),
    (40011, 'Orgnization skills'),
    (40012, 'Adaptability'),
    (20000, 'Communication'),
    (20001, 'Recruitment'),
    (20002, 'Coaching'),
    (20003, 'Human resource management'),
    (20004, 'Talent management'),
    (20005, 'Employee engagement'),
    (20006, 'Employee Relations'),
    (20007, 'Advising'),
    (10000, 'Accounting'),
    (10001, 'Financial statement'),
    (10002, 'Budget'),
    (10003, 'Investment management'),
    (10004, 'Mathematics'),
    (10005, 'Forecasting'),
    (10006, 'Taxation'),
    (10007, 'Tax planning');
...
insert into job values
    (600, "Dev Ops Engineer", "lorem"),
    (601, "Frontend developer", "lorem"),
    (602, "Cloud Specialist", "lorem"),
    (603, "Security Engineer", "lorem"),
    (300, 'Sales Representative', 'lorem'),
    (301, 'Account Executive', 'lorem'),
    (302, 'Sales Manager', 'lorem'),
    (303, 'Business Development Manager', 'lorem'),
    (304, 'Salesperson', 'lorem'),
    (305, 'Sales Consultant', 'lorem'),
    (306, 'Sales Development Representative', 'lorem'),
    (307, 'Sales Rep', 'lorem'),
    (308, 'Inside Sales Representative', 'lorem'),
    (400, 'Operations Manager', 'lorem'),
    (401, 'Operations Coordinator', 'lorem'),
    (402, 'Operations Analyst', 'lorem'),
    (403, 'Operations Specialist', 'lorme'),
    (404, 'Operations Assistant', 'lorem'),
    (405, 'Operations Supervisor', 'lorem'),
    (406, 'Operations Associate', 'lorme'),
    (407, 'Operations Engineer', 'lorem'),
    (200, 'HR associate', 'lorem'),
    (201, 'HR representative', 'lorem'),
    (202, 'HR administrator', 'lorem'),
    (203, 'HR specialist', 'lorem'),
    (204, 'HR generalist', 'lorem'),
    (205, 'HR supervisor', 'lorem'),
    (206, 'HR analyst', 'lorem'),
    (100, 'Financial analyst', 'lorem'),
    (101, 'Audit', 'lorem'),
    (102, 'Financial adviser', 'lorem'),
    (103, 'Bookkeeper', 'lorem'),
    (104, 'Credit analyst', 'lorem'),
    (105, 'Financial manager', 'lorem'),
    (106, 'Tax Accountant', 'lorem');


insert into job_skill values
    (600, "Dev Ops Engineer", 60000),
    (600, "Dev Ops Engineer", 60001),
    (601, "Frontend developer", 70000),
    (601, "Frontend developer", 70001),
    (602, "Cloud Specialist", 80000),
    (602, "Cloud Specialist", 60001),
    (603, "Security Engineer", 50000),
    (603, "Security Engineer", 80000),
    (603, "Security Engineer", 40000),
    (202, 'HR administrator', 20003),
    (202, 'HR administrator', 20007),
    (304, 'Salesperson', 30010), 
    (304, 'Salesperson', 30005),
    (304, 'Salesperson', 30002),
    (105, 'Financial manager', 10001),
    (105, 'Financial manager', 10003),
    (105, 'Financial manager', 10006);
